...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'param_whitelist', default_value="['.*']"
        ),
        DeclareLaunchArgument(
            'service_whitelist', default_value="['.*']"
        ),
        DeclareLaunchArgument(
            'client_topic_whitelist', default_value="['.*']"
        ),
        DeclareLaunchArgument(
            'min_qos_depth', default_value="1"
        ),
        DeclareLaunchArgument(
            'max_qos_depth', default_value="10"
        ),
        DeclareLaunchArgument(
            'num_threads', default_value="0"
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            'include_hidden', default_value="false"
        ),
        DeclareLaunchArgument(
            'asset_uri_allowlist',
        ...
        DeclareLaunchArgument(
            'ignore_unresponsive_param_nodes', default_value="true"
        ),
