...
void KeyFrame::PostLoad(std::map<long unsigned int, KeyFrame*>& mpKFid, std::map<long unsigned int, MapPoint*>& mpMPid, std::map<unsigned int, GeometricCamera*>& mpCamId){
    ...
    mConnectedKeyFrameWeights.clear();
    for(auto it = mBackupConnectedKeyFrameIdWeights.begin(), end = mBackupConnectedKeyFrameIdWeights.end();
        it != end; ++it)
    {
    ...
    // KeyFrame childrens
    mspChildrens.clear();
    for(auto it = mvBackupChildrensId.begin(), end = mvBackupChildrensId.end(); it!=end; ++it)
    {
    ...
    // Loop edge KeyFrame
    mspLoopEdges.clear();
    for(auto it = mvBackupLoopEdgesId.begin(), end = mvBackupLoopEdgesId.end(); it != end; ++it)
    {
    ...
    // Merge edge KeyFrame
    mspMergeEdges.clear();
    for(auto it = mvBackupMergeEdgesId.begin(), end = mvBackupMergeEdgesId.end(); it != end; ++it)
    {
